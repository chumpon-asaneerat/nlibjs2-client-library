...
const defaultWSvr = { 
    ...
    public: {
        paths: [
            ...
            { route: "/dist", path: "public/dist/tabulator-4.6.0", maxAge: distMaxAge, enable: true },
            { route: "/dist/js", path: "public/dist/ace-1.4.10", maxAge: distMaxAge, enable: true },
            ...
            { route: "/dist", path: "public/dist/fabricjs-3.6.2", maxAge: distMaxAge, enable: true },
            ...
            { route: "/dist/js", path: "public/dist/signature-pad-3.0.0.beta.3", maxAge: distMaxAge, enable: true },
            { route: "/components", path: "dist/component/riot", maxAge: distMaxAge, enable: true },
            { route: "/dist", path: "src/client", maxAge: "15s", enable: true }
        ]
    }
};
